...
namespace NavMeshExtension
{
    ...
    public class ReviewWindowEditor : EditorWindow
    {
		...
		private static string keyName = "NavMeshExtension-Review";
        ...
        [MenuItem("Window/NavMesh Extension/Review Asset")]
        static void Init()
        {
        ...
        {		
			...
			EditorGUILayout.BeginHorizontal();
			GUILayout.Space(30);
			EditorGUILayout.LabelField("Review NavMesh Extension", GUILayout.Width(200));
			EditorGUILayout.EndHorizontal();
            ...
            {
				Help.BrowseURL("https://www.assetstore.unity3d.com/#!/content/16910");
                DisableRating();
            }
